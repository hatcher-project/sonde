...
class TwigEnvironmentReporter extends \Twig_Environment
{
    ...
    /**
     * TwigEnvironmentReporter constructor.
     * @param \Twig_Environment $twig
     * @param Sonde $sonde
     */
    public function __construct(\Twig_Environment $twig, Sonde $sonde)
    {
        $this->twig = $twig;
        $this->sonde = $sonde;
    }
    ...
    public function loadTemplate($name, $index = null)
    {
        ...
        return $this->twig->loadedTemplates[$cls] = new TwigTemplateReporter(new $cls($this), $this->sonde);
    }
    ...
    {
        return $this->twig->initGlobals();
    }

    protected function initExtensions()
    {
        $this->twig->initExtensions();
    }

    protected function initExtension(Twig_ExtensionInterface $extension)
    {
        $this->twig->initExtension($extension);
    }

    protected function writeCacheFile($file, $content)
    {
        $this->twig->writeCacheFile($file, $content);
    }
